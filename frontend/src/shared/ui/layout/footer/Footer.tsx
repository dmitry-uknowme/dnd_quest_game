...
const Footer = () => {
	const [bannerEnabled, setBannerEnabled] = useState<boolean | undefined>(undefined);
	const [bannerVisible, setBannerVisible] = useState<boolean | undefined>(undefined);
	...
	useEffect(() => {
		const storage = localStorage.getItem("globalFeaturesDisableSubscribeBanner");
		if (!storage) {
			...
			setBannerEnabled(!Boolean(parseInt(localStorage.getItem("globalFeaturesDisableSubscribeBanner") as string)));
		}
	}, []);
			...
			<section>
				<div className="container">
					<div className="p-0!">
						...
						<h3 className="mt-5 mb-10 md:block hidden">Оставьте свои контакты и мы с вами свяжемся</h3>
						<h4 className="mt-5 mb-10 md:hidden block">Оставьте свои контакты и мы с вами свяжемся</h4>
						<Dialog>
					...
					<div className="py-5 md:py-6">
						<Banner
							...
							onClose={() => {
								...
								localStorage.setItem("globalFeaturesDisableSubscribeBanner", "1");
							}}
							content={
								<div className="flex flex-wrap gap-5 items-center justify-between w-full">
									...
									<a href="https://t.me/viktor_it_life" target="_blank" rel="noopener noreferrer">
